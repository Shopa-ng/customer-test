...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <TouchableOpacity
      ...
      className="mb-4 w-[48%]"
    >
      <View className="rounded-lg border border-gray-light bg-white">
        <View className="relative mb-2 h-[180px] w-full overflow-hidden rounded-t-lg items-center justify-center p-2">
          <Image
